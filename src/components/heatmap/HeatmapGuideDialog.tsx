...
export function HeatmapGuideDialog({ open, onOpenChange, dark, statusLine }: HeatmapGuideDialogProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[min(85vh,720px)] flex-col gap-0 overflow-hidden border-amber-400/25 bg-background/85 p-0 pt-6 backdrop-blur-xl shadow-[0_0_48px_-16px_rgba(234,179,8,0.35)] sm:max-w-lg">
        <DialogHeader className="shrink-0 space-y-1 px-6 pb-4">
        ...
        <div className="min-h-0 flex-1 space-y-6 overflow-y-auto overflow-x-hidden overscroll-contain px-6 pb-6">
          ...
          <section className="space-y-2">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              <span className="font-semibold text-rose-800 dark:text-rose-200">Max</span> badges appear only when at
